...
#'
#' @description Several helper functions to assist in reading data directly from sensor outputs. Should return a dataframe in correct format
#' for use with the rest of the \code{iglu} package. Assumes all data will be readable with base R read.csv function.
#'
#' @usage importlibre("cgmdata.csv", id = "read")
#'
#' @param filename String matching the name of the data to be read. Assumed to be .csv
#'
#' @param id String indicating subject id. Defaults to "read" or "filename" depending on the import function.
...
#'
#' @return A dataframe containing the data read from the provided file.
#'
#' @export
#'
